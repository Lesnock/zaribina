...
use App\Modules\Catalog\Application\UseCases\CreateOption\CreateOption;
use App\Modules\Catalog\Application\UseCases\CreateOption\Input;
...
test('option is created and saved in repository', function () {
    ...
    $sut->execute(new Input(name: 'Test Category', values: []));
